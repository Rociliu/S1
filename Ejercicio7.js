...
console.log("El precio final del primer coche es de: " + (car1.finalPrice = car1.basePrice + globalBasePrice));
console.log("El precio final del segundo coche es de: " + (car2.finalPrice = car2.basePrice + globalBasePrice));